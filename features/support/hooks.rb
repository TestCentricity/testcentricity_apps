...
#   apps devices:            @!ipad, @!iphone


# block feature/scenario execution if running against iPad apps browser
Around('@!ipad') do |scenario, block|
  qualify_device('ipad', scenario, block)
end


# block feature/scenario execution if running against iPhone apps browser
Around('@!iphone') do |scenario, block|
  qualify_device('iphone', scenario, block)
end


# block feature/scenario execution if running against a physical apps device
...
# block feature/scenario execution if running against an emulated apps device
