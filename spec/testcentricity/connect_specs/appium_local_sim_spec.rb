...
describe TestCentricity::AppiumConnect, required: true do
  ...
  describe 'Connect to locally hosted apps device simulator using W3C desired_capabilities hash' do
  ...
  context 'Connect to locally hosted apps device simulator using environment variables' do
