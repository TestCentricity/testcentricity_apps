...
RSpec.describe TestCentricity::AppiumConnect, custom: true do
  ...
  before(:context) do
    ...
    ENV['AUTOMATE_PROJECT'] = 'TestCentricity Apps - BrowserStack'
    ENV['AUTOMATE_BUILD'] = "Version #{TestCentricityApps::VERSION}"
  end
      ...
      options = {
        ...
        capabilities: {
          ...
          'bstack:options': {
            ...
            buildName: "Version #{TestCentricityApps::VERSION}",
